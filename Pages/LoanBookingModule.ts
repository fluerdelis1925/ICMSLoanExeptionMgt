...
export class LoanBookingPage
{
 ...
 private readonly NatureOfWork: Locator;
   ...
   constructor(page:Page)
   {
     ...
     this.NatureOfWork = this.page.locator("#industry").locator("option");
   }
  ...
  async Detailformations(natureOFWork: string) :Promise<void>
  {
  ...
  await this.page.locator("#industry").click();

await this.page.getByRole("option", {
    name: data.natureOFWork,
    exact: true
}).click();
/*
